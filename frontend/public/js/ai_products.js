document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- START: Hardcoded Bot Data ---
    // Bot data generated based on your specifications, sorted by price.
    // The 'daysLeft' for Grand Opening offers is calculated dynamically.
    const ALL_BOTS_DATA = [
  {
    "id": 1,
  ...
  },
  {
    ...
    async function handleBuyBot(event) {
        ...
        try {
            // Note: If you hardcode bot data in frontend, your backend /api/bots/purchase
            // might still expect to fetch bot details by ID. Ensure backend handles
            // purchase logic correctly without needing to re-fetch bot details it already knows.

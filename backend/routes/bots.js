...
const bots = [
  ...
  { id: 2, name: "UBT Bot #2", price: 200, lockInDays: 4, dailyCredit: 2, hasBonus: false, bonusCreditAmount: 0.0, bonusCreditInterval: null, specialFeature: "Accelerated profit generation and daily insights.", totalReturnAmount: 216, totalProfit: 16, profitRatio: 0.08 },
  { id: 3, name: "UBT Bot #3", price: 600, lockInDays: 8, dailyCredit: 3, hasBonus: true, bonusCreditAmount: 20, bonusCreditInterval: "every 120 days", specialFeature: "Enhanced returns for dedicated investors.", totalReturnAmount: 624, totalProfit: 24, profitRatio: 0.04 },
  { id: 4, name: "UBT Bot #4", price: 1300, lockInDays: 16, dailyCredit: 4, hasBonus: false, bonusCreditAmount: 0.0, bonusCreditInterval: null, specialFeature: "Accelerated profit generation and daily insights.", totalReturnAmount: 1356, totalProfit: 56, profitRatio: 0.043 },
  { id: 5, name: "UBT Bot #5", price: 3200, lockInDays: 32, dailyCredit: 5, hasBonus: false, bonusCreditAmount: 0.0, bonusCreditInterval: null, specialFeature: "Enhanced returns for dedicated investors.", totalReturnAmount: 3360, totalProfit: 160, profitRatio: 0.05 },
  { id: 6, name: "UBT Bot #6", price: 7500, lockInDays: 64, dailyCredit: 6, hasBonus: true, bonusCreditAmount: 60, bonusCreditInterval: "every 120 days", specialFeature: "Accelerated profit generation and daily insights.", totalReturnAmount: 7680, totalProfit: 180, profitRatio: 0.024 },
  { id: 7, name: "UBT Bot #7", price: 17800, lockInDays: 128, dailyCredit: 7, hasBonus: false, bonusCreditAmount: 0.0, bonusCreditInterval: null, specialFeature: "Enhanced returns for dedicated investors.", totalReturnAmount: 18096, totalProfit: 296, profitRatio: 0.017 },
  { id: 8, name: "UBT Bot #8", price: 42200, lockInDays: 256, dailyCredit: 8, hasBonus: false, bonusCreditAmount: 0.0, bonusCreditInterval: null, specialFeature: "Accelerated profit generation and daily insights.", totalReturnAmount: 44248, totalProfit: 2048, profitRatio: 0.049 },
  { id: 9, name: "UBT Bot #9", price: 100000, lockInDays: 512, dailyCredit: 9, hasBonus: true, bonusCreditAmount: 200, bonusCreditInterval: "every 120 days", specialFeature: "Enhanced returns for dedicated investors.", totalReturnAmount: 104608, totalProfit: 4608, profitRatio: 0.046 },
  { id: 10, name: "VIP Elite UBT Bot", price: 100000, lockInDays: 1024, dailyCredit: 10, hasBonus: true, bonusCreditAmount: 400, bonusCreditInterval: "every 90 days", specialFeature: "Dedicated VIP investment consultant for priority support and optimal returns.", totalReturnAmount: 110240, totalProfit: 10240, profitRatio: 0.102 }
];
